...
function maiornumero () {
    let numero1 = parseFloat(prompt("Muito bem, parceiro intergaláctico! Estamos explorando um planeta alienígena misterioso, e, olha só, encontramos três artefatos alienígenas protegidos por um campo de energia enigmático. Parece que o universo nos desafiou mais uma vez.\nAqui está o negócio: você precisa declarar três números, e eu vou verificar qual deles é o maior para desativar o campo e avançar.\nA tarefa é clara: escolha os números com sabedoria, e eu vou determinar qual é o maior.\nAventureiro, a decisão está nas suas mãos. Digite os três números"));
    let numero2 = parseFloat(prompt("Digite o segundo número:"));
